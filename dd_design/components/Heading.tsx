...
/**
 * Sentence-case headlines. For emphasis, wrap ONE keyword in <em> — it
 * renders italic in the DDBoss accent (purple). Never bold for emphasis.
 *   <Heading level={1}>Toma <em>el control</em></Heading>
 */
...
/** ALL-CAPS tracked eyebrow above a heading or card. */
