...
// `whitespace-nowrap` keeps badges on one line (no multi-line "blob" on long text).
// To truncate a long value, the consumer must cap width on the Badge (`max-w-*`) AND
// wrap the text in an inner `<span className="min-w-0 truncate">` — see the Type column
// in ExpensesPage. Without a max-w, a long badge will extend rather than truncate.
const base =
