...
# FastAPI bug: CORSMiddleware no añade headers a respuestas HTTPException en algunos casos.
# Este handler explícito garantiza que los errores 4xx lleven Access-Control-Allow-Origin.
